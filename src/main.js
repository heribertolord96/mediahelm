...
const strings = {
  en: {
    ...
    nav_terms: 'Terms',
    nav_cta: 'Coming soon',
    hero_eyebrow: 'Mobile app · Android & iOS',
    hero_title_a: 'Your media app.',
    hero_title_b: 'Cast when linked.',
    hero_sub:
      'MediaHelm is a mobile app for your phone: browse the web, open local files, and watch TV — then cast to a device on your Wi‑Fi. Built for Android & iOS.',
    cta_primary: 'Coming soon on the stores',
    cta_secondary: 'Privacy & Terms',
    cta_note: 'Free donationware — no ads, no account, no paywall. Not listed yet.',
    platform_android: 'In progress · Google Play',
    platform_ios: 'In progress · App Store',
    features_label: 'What you can do',
    features_title: 'One mobile app for web, files, TV & cast',
    features_sub: 'Built for your phone and your local network — discovery and media stay on the LAN.',
    ...
    footer_tag: 'Mobile app for Android & iOS — play-first LAN media.',
  ...
  es: {
    ...
    hero_eyebrow: 'App móvil · Android e iOS',
    hero_title_a: 'Tu app de media.',
    hero_title_b: 'Castea cuando enlaces.',
    hero_sub:
      'MediaHelm es una app móvil para tu teléfono: navega la web, abre archivos locales y mira TV — luego casteá a un dispositivo en tu Wi‑Fi. Para Android e iOS.',
    cta_primary: 'Próximamente en las tiendas',
    cta_secondary: 'Privacidad y Términos',
    cta_note: 'Donationware gratis — sin anuncios, sin cuenta, sin paywall. Aún no publicada.',
    platform_android: 'En curso · Google Play',
    platform_ios: 'En curso · App Store',
    features_label: 'Qué puedes hacer',
    features_title: 'Una app móvil para web, archivos, TV y cast',
    features_sub: 'Hecha para tu teléfono y tu red local — descubrimiento y media se quedan en la LAN.',
    ...
    footer_tag: 'App móvil para Android e iOS — media LAN play-first.',
